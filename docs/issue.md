...
**1. 朋友圈功能**
*   角色发布的朋友圈，能够成功请求API进行内容输出，但帖子没有在explore页面加载出来
...
*   如果在图片还没生成完成的时候过程中退出应用，再打开应用时，如果这时候图片生成成功了，则会无限下载图片，必须删除掉角色才能解决此问题
*   刷新的功能似乎会直接触发从服务器下载图片的请求，请检查？如果存在，我们不需要这项功能。
*   提示词的逗号后面不要有空格
*   允许调整提示词的顺序（待优化）
