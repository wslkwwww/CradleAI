...
## 下载APK：
[下载APK](https://cradleintro.top/Cradle-1.0.0%20-release.apk)
...
0501：【已修复】gemini渠道高级设置模型无法切换的问题

## 正在修复的问题：

1.部分安卓手机无法上下滑聊天界面（红米部分型号）

2.角色设定界面的角色描述，特征暂时没有可放大编辑的文本框

3.暂不支持渲染markdown，隐藏思维链，手动导入正则的问题

4.部分预设导入错误（可先重试一两次能否导入）
